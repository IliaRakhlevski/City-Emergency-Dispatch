...
FREERTOS_PLUS_DIR_REL := ./core/FreeRTOS-Plus
FREERTOS_PLUS_DIR     := $(abspath $(FREERTOS_PLUS_DIR_REL))

KERNEL_DIR            := ${FREERTOS_DIR}/core/Source
...
INCLUDE_DIRS          += -I${FREERTOS_DIR}/core/Common/include
...
# Demo library.
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/AbortDelay.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/BlockQ.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/blocktim.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/countsem.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/death.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/dynamic.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/EventGroupsDemo.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/flop.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/GenQTest.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/integer.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/IntSemTest.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/MessageBufferAMP.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/MessageBufferDemo.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/PollQ.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/QPeek.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/QueueOverwrite.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/QueueSet.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/QueueSetPolling.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/recmutex.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/semtest.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/StaticAllocation.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/StreamBufferDemo.c
SOURCE_FILES          += ${FREERTOS_DIR}/core/Common/Minimal/StreamBufferInterrupt.c
